            ...
            <div id="certificate-badge-row" className="row">
                {
                    certBadgeSrc.length > 0 ?
                        <>
                            <div className="col-12 col-sm-9 col-md-9 col-lg-9 col-xl-9 px-0 mx-0"> {/* Set padding and margin to 0 */}
                                <h3>{certTitle}</h3>
                            ...
                            <div id="certificate-badge-col" className="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-2 px-0 mx-0"> {/* Set padding and margin to 0 */}
                                <img className="certificate-badge" src={`${certBadgeSrc}`} alt={`Certificate badge for: ${certSubtitle}`} />
                            </div>
                        </>
                        : 
                        <>
                        <div className="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-12 px-0 mx-0"> {/* Set padding and margin to 0 */}
                            <h3>{certTitle}</h3>
